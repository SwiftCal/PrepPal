...
// new meal page item, for now this works hand in hand but as a strech we could update it later
struct MealPageItem: Identifiable, Codable {
...
struct MealSection: Codable {
    var title: String
    var ingredients: [NewIngredientItem]
}
